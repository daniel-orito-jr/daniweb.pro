...
Daniweb.pro is a CodeIgniter front-end only application which has two supported installation methods: manual download, or using Composer. I recommend the Composer installation because it keeps CodeIgniter up to date easily.
